# tokenhsi/env/tasks/transition_skills/humanoid_state_transition_4skills_enhanced.py
...
class HumanoidStateTransition4Skills(HumanoidLongTerm4BasicSkills):
    """
    增强版四技能状态转移训练环境
    支持所有技能对之间的状态转移学习
    """
    ...
    def _compute_base_task_rewards(self):
        """计算基础任务奖励（复用原有的奖励函数）"""
        # 调用父类的奖励计算方法
        return super()._compute_reward_components()
