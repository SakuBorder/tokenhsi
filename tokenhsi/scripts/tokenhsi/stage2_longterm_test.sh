...
python ./tokenhsi/run.py --task HumanoidLongTerm4BasicSkills \
    ...
    --cfg_task_plan tokenhsi/data/dataset_longterm_task_completion/task_plans/4_basic_skills_0/traj_carry_traj.yaml \
    --motion_file tokenhsi/data/dataset_loco_sit_carry_climb.yaml \
    --hrl_checkpoint output/tokenhsi/ckpt_stage1.pth \
    --checkpoint output/Humanoid_24-10-07-19/nn/Humanoid.pth\
    --test \
    --num_envs 1