...
from .utils.xml_parser import parse_geom_elements_from_xml, parse_mesh_elements_from_xml
...
def vis_motion_use_scenepic_animation(
    ...
    rigidbody_names, rigidbody_meshes = parse_mesh_elements_from_xml(asset_filename)
    # import ipdb; ipdb.set_trace()  # Debugging line to inspect the loaded meshes
